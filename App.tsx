        ...
        <div className="bg-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 shadow-2xl border border-slate-100">
              ...
              <div className="space-y-6">
                      ...
                      {interest === 'Plano de Saúde Empresarial' && (
                        <div className="flex items-start space-x-3 bg-white/60 p-4 rounded-2xl border border-blue-200">
                          ...
                          <p className="text-[11px] text-blue-800 font-medium leading-relaxed">
                            Para empresas, analisamos carências e rede credenciada de forma personalizada.
                          </p>
                        </div>
                      )}
                    </div>
                ...
                {interest === 'Seguro Empresarial' && (
                  <div className="grid grid-cols-1 gap-4">
                    <input type="text" placeholder="Nome da Empresa" className="input-field" value={businessData.empresa} onChange={e => setBusinessData({...businessData, empresa: e.target.value})} />
                    <input type="text" placeholder="Ramo de Atividade" className="input-field" value={businessData.ramo} onChange={e => setBusinessData({...businessData, ramo: e.target.value})} />
                  </div>
                )}
          ...
          {step === 3 && (
            <div className="text-center space-y-6 animate-in zoom-in-95 duration-500">
              ...
              <p className="text-slate-500 font-medium max-w-sm mx-auto">Sua cotação técnica foi processada. Estamos redirecionando para o WhatsApp.</p>
